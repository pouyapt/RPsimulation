...
private:
    ...
    std::string activeMinersCsvFile = "output/active_miners.csv";
    std::string inactiveMinersCsvFile = "output/inactive_miners.csv";
...
private:
    ...
    std::string activePoolsCsvFile = "output/active_pools.csv";
    bool readPools ();
    void writePools ();
