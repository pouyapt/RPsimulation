...
private:
    ...
    double powerConsumptionMean = 0.07; //cents for kilowatt per hour
    double powerConsumptionStd = 0.015;
    double powerConsumptionMin = 0.02;
    double powerConsumptionMax = 0.10;
    double poolFeeMin = 15; //(divided by 10) percent
    double poolFeeMax = 18;
    double POWrewardMin = 29; //(divided by 10) percent
    double POWrewardMax = 32;
    ...
    int poolMinumumMembershipTimeMean = 5; //in months
    int poolMinumumMembershipTimeStd = 1;
    int poolMinumumMembershipTimeMin = 4;
    int poolMinumumMembershipTimeMax = 6;
